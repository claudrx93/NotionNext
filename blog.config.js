...
const BLOG = {
  AUTHOR: 'Miantu', // 作者
  BIO: 'A IT men ', // 作者简介
  LINK: 'http://miantux.com', // 网站地址
  KEYWORDS: 'Miantux, blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '8e13ea9fbfc54a169f4a9eeecd495fb3', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'claudrx93@qq.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/claudrx93', // 你的github个人主页
